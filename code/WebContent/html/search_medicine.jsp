...
<body>
	...
	<form class="reg-tab" action="/HospitalManagementSystem/Pharmacist" method="post">
		...
		<table>
			...
			<tbody>
				<tr>
					...
					<td><form action="/HospitalManagementSystem/html/Pharmacist" method="post"><input type="Search" name="ssn_id" value="<%=patient_id %>" required /><button type="Submit" name="function" value="forward" class="btn">Issue Medicines</button></form></td>
				</tr>
				<tr>
					<td>Patient Name: </td>
		...
		<button class="btn" type="Submit" name="function" value="search">Search</button>
