...
<body>
	...
	<form class="reg-tab" action="/HospitalManagementSystem/Diagnostic" method="post">
		...
		<table>
			...
			<tbody>
				<tr>
					...
					<td><form action="/HospitalManagementSystem/Diagnostic" method="post"><input type="Search" name="ssn_id" value="<%=patient_id %>" required /><button type="Submit" name="function" value="forward" class="btn">Issue Tests</button></form></td>
				</tr>
				<tr>
					<td>Patient Name: </td>
